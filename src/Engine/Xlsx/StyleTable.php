...
final class StyleTable implements StyleRegistry
{
    ...
    /**
     * @var list<array{numFmtId: int, fontId: int, fillId: int, borderId: int, alignment: string}>
     */
    ...
    /**
     * Builds a stable dedup key so styles with identical formatting share one cellXfs entry.
     *
     * @param Style $style
     *
     * @return string
    ...
    /**
     * Registers the style's font, returning its shared font id (0 for the default font).
     *
     * @param Style $style
     *
     * @return int
    ...
    /**
     * Registers the style's solid background fill, returning its shared fill id (0 when none).
     *
     * @param Style $style
     *
     * @return int
    ...
    /**
     * Registers the style's four border edges, returning its shared border id (0 when none).
     *
     * @param Style $style
     *
     * @return int
    ...
    /**
     * Serializes one border edge to its OOXML element, with style and optional color.
     *
     * @param string $tag
     * @param ?Border $border
     *
    ...
    /**
     * Serializes the style's alignment and wrap settings to an <alignment> element, or empty.
     *
     * @param Style $style
     *
     * @return string
    ...
    /**
     * Returns the numFmt id for the style's format code, allocating a custom id on first use.
     *
     * @param Style $style
     *
     * @return int
    ...
    /**
     * Serializes the style's font as a differential-formatting <font> fragment, or empty.
     *
     * @param Style $style
     *
     * @return string
    ...
    /**
     * Serializes the style's background as a differential-formatting <fill> fragment, or empty.
     *
     * @param Style $style
     *
     * @return string
