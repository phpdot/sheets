...
final class XlsxDrawingCollector implements DrawingCollector
{
     ...
     * @param PartCounter $drawingCounter
     * @param PartCounter $mediaCounter
     * @param PartCounter $chartCounter
     */
    ...
    /**
     * Returns the drawing part path, allocating a numbered drawingN.xml on first use.
     *
     * @return string
     */
