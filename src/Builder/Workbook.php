...
final class Workbook
{
    ...
    /**
     * Opens a workbook to be written to the given path, optionally with a shared-strings table.
     *
     * @param string $path
    ...
    /**
     * Sets the document description property.
     *
    ...
    /**
     * Lazily creates the streaming writer on first use, seeding the document properties.
     *
     * @return Writer
     */
    ...
    /**
     * Validates and trims a sheet name (<=31 chars, legal characters, case-insensitively unique).
     *
     * @param string $name
     *
     * @return string
    ...
    /**
     * Throws once the writer exists — document properties must precede the first sheet.
     *
     * @return void
     */
    ...
    /**
     * Throws once the workbook has already been saved.
     *
     * @return void
     */
